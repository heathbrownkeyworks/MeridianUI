# Meridian UI Modding and Linking Exceptions

Meridian UI is "the Program" for the purposes of these additional permissions.

The "Modded Code" is Skyrim and its variants, together with hardware drivers and proprietary SDKs that enable optional functionality such as NVIDIA DLSS or Streamline and AMD FidelityFX FSR.

The "Modding Libraries" are SKSE, the Windows SDK and Windows runtime libraries.
