...
- Added Windows DXVK support for built-in NIF previews while preserving game rendering state.
...
Production NIF renderer tests passed on native D3D11 and DXVK; in-game preview validation remains pending.
