...
namespace Meridian::Converters
{
    ...
    public:
        ...
        /// <summary>
        /// Inverse of ConvertValue: builds a V8 value tree from a CefValue
        /// tree (e.g. a promise IPC_JS_PROMISE_RESULT payload parsed via
        /// CefParseJSON). Must be called only while inside an entered
        /// CefV8Context -- CefV8Value::Create* calls require one.
        /// </summary>
        static CefRefPtr<CefV8Value> ConvertToV8(const CefRefPtr<CefValue>& a_value);
    };
}
